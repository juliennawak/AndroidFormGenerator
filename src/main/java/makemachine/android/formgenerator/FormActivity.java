...
public abstract class FormActivity extends Activity
{
	...
	// -- widgets
	protected static LinearLayout _container;
	protected static LinearLayout _layout;
	protected static ScrollView   _viewport;
	...
	public View findWidget(String name){
		return _map.get(name)._view;
	}
}
